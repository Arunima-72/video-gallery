...
// import React, { useEffect, useState } from 'react'; //last updated code 31/07 10.30
// import {
...
//       const stackNameMatch = video.stackName?.toLowerCase().includes(search);
//       const categoryNameMatch = video.categoryName?.toLowerCase().includes(search);
//       const subcategoryNameMatch = video.subcategoryName?.toLowerCase().includes(search);

//       const stackMatch = selectedStack ? video.stack === selectedStack : true;
//       const categoryMatch = selectedCategory ? video.category === selectedCategory : true;
//       const subcategoryMatch = selectedSubcategory ? video.subcategory === selectedSubcategory : true;

//       return (
//         (titleMatch || stackNameMatch || categoryNameMatch || subcategoryNameMatch) &&
//         stackMatch &&
//         categoryMatch &&
//         subcategoryMatch
//       );
...
//           fullWidth
//           variant="outlined"
//           placeholder="Search by title, stack, category or subcategory..."
//           value={searchTerm}
...
//                     e.target.src = "https://via.placeholder.com/160x90";
//                   }}
//                 />
//                 <CardContent>
...
//                       {video.stackName}
//                     </Typography>
//                     <IconButton onClick={(e) => handleMenuOpen(e, video._id)}>
//                       <MoreVertIcon />
//                     </IconButton>
//                   </Box>
//                 </CardContent>
